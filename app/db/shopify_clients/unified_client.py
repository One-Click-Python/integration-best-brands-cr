...
class ShopifyGraphQLClient(BaseShopifyGraphQLClient):
    ...
    async def get_orders(
        self, limit: int = 250, cursor: Optional[str] = None, query: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def get_specialized_client(self, client_type: str):
        ...
        """
        clients = {"products": self.products, "collections": self.collections, "inventory": self.inventory}
