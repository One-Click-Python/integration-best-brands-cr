"""
Inventory and location-related GraphQL operations for Shopify API.

This module contains all GraphQL queries and mutations specifically related
to inventory management and store locations, including inventory adjustments,
location queries, and inventory item management.
"""
