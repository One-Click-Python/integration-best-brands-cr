...
def with_retry(
    max_attempts: int = 3, delay: float = 1.0, backoff: float = 2.0, exceptions: tuple = (RMSConnectionException,)
) -> Callable:
    """
...
class BaseRepository(ABC):
    ...
    @log_operation()
    async def execute_query_with_commit(self, query: str, params: Optional[Dict[str, Any]] = None) -> Any:
        """
