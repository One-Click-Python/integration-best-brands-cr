...
class RMSTaxonomyMapper:
    ...
    FAMILIA_TO_SHOPIFY_MAPPING = {
        ...
        "n/d": {"product_type": "Unspecified", "search_terms": ["unspecified", "general"], "taxonomy_base": "Other"},
    }
    ...
    CATEGORIA_TO_TAXONOMY_MAPPING = {
        ...
        "Botas": {"taxonomy_search": ["Boots", "Ankle Boots"], "product_type": "Boots", "taxonomy_id": None},
        "Botines": {"taxonomy_search": ["Ankle Boots", "Booties"], "product_type": "Ankle Boots", "taxonomy_id": None},
        "Sandalias": {"taxonomy_search": ["Sandals", "Summer Shoes"], "product_type": "Sandals", "taxonomy_id": None},
        "Flats": {"taxonomy_search": ["Flats", "Ballet Flats"], "product_type": "Flats", "taxonomy_id": None},
        "Tacones": {
            "taxonomy_search": ["High Heels", "Dress Shoes"],
            "product_type": "High Heels",
            "taxonomy_id": None,
        },
        "Cuñas": {"taxonomy_search": ["Wedges", "Platform Shoes"], "product_type": "Wedges", "taxonomy_id": None},
        "Casual": {
        ...
        # Ropa
        "Ropa": {"taxonomy_search": ["Clothing", "Apparel"], "product_type": "Clothing", "taxonomy_id": None},
        "NIÑA-CASU-CERR": {
        ...
        "Bolsos": {"taxonomy_search": ["Handbags", "Bags", "Purses"], "product_type": "Handbags", "taxonomy_id": None},
        # Categorías especiales
        "Mixto": {"taxonomy_search": ["Unisex", "Mixed"], "product_type": "Unisex", "taxonomy_id": None},
        "Transito": {"taxonomy_search": ["Transit", "Temporary"], "product_type": "Transit", "taxonomy_id": None},
        "Miscelaneos": {
            "taxonomy_search": ["Miscellaneous", "Other"],
            "product_type": "Miscellaneous",
            "taxonomy_id": None,
        },
        "n/d": {"taxonomy_search": ["Unspecified", "Not Defined"], "product_type": "Unspecified", "taxonomy_id": None},
    }
    ...
    def create_metafields(
        self, familia: str, categoria: str, talla: str, color: str, additional_data: Optional[Dict[str, Any]] = None
    ) -> List[Dict[str, Any]]:
        """
